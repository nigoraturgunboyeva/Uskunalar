...
import { DeleteAllBasket, DeleteAllLiked, DeleteLiked, Deletebasket, SelectBasket, SelectLiked, SelectScale } from '../../../Redux/Main';
...
export default function Basket() {
    ...
    const handleDeleteAllBasket= (item) => {
    dispatch(DeleteAllBasket(item))
    }
...
<div className='top-of-liked'>
    <div> <h1 className='likedh1'>Savat</h1>
    <h2 className='likedh2'><div className='span1'></div><div className='span2'></div></h2>
    </div>
    <div className='deleteall' onClick={handleDeleteAllBasket}><div className='delete-btn' ><IoTrashOutline /></div><div>Barchasini o'chirish</div></div>
   </div>
    <div className="products">
           {
            basket.map((item) => (
                ...
                <figcaption>
                   <div className="desc">
                    <div>
                        <div className='liked-btn' onClick={() => handleDeleteBasket(item)}> <IoTrashOutline/></div>
    ...
    <div className="product">
       <div className='liked-none'>
        <h1 className='likednoneh1'>Savat</h1>
